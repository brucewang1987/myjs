              ...
              $.ajax({
                  ...
                  success: function (ret) {
                      ...
                      $(_json).each(function (key) {
                          ...
                          $("#ctn_type").val(_json[key].r_cnttype);
                          $("#ctn_size").val(_json[key].r_cntsize);
...
//                          i++;
                          ...
                          $("#ctn_no").val(_json[key].r_cntno);
                          $("#MODEL_NUM").val(_json[key].MODEL_NUM);
                          $("#MACH_TYPE").val(_json[key].MACH_TYPE);
                          $("#UNIT_SERIAL_NUM").val(_json[key].UNIT_SERIAL_NUM);
                          $("#SnowSeed").val(_json[key].SnowSeed);
                          $("#unit_voltage").val(_json[key].unit_voltage);
                          $("#pti_type").val(_json[key].pti_type);
                          $("#pti_status").val(_json[key].pti_status);
                          $("#unit_date").val(_json[key].unit_date);
                      });
//                      $("#RepairbillInfotable").html(html);
