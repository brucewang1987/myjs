  function init() {
        ...
        $.ajax({
            ...
            success: function (ret) {
                ...
                $(_json).each(function (key) {
                    ...
                    html += "<td>" + _json[key].unit_date + "</td>"; //20
                    html += "</tr>";
                    i++;
    ...
    function Settlement(i) {
        ...
        var unit_date = $("#RepairbillInfotable").find("tr").eq(i).find("td").eq(20).text();
    ...
    function UpdateUnitData() {
        ...
        if (MACH_TYPE == "" && MODEL_NUM == "" && UNIT_SERIAL_NUM == "" && SnowSeed == "" && unit_voltage == "" && pti_type == "" && unit_date=="") {
        ...
        $.ajax({
            ...
            url: "/RepairbillInfo/AddColdCtnInfo?val1=" + MACH_TYPE + "&val2=" + MODEL_NUM + "&val3=" + UNIT_SERIAL_NUM
               + "&val4=" + SnowSeed + "&val5=" + unit_voltage + "&val6=" + pti_type + "&val7=" + r_id +
                "&val8=" + unit_date + "&val88=" + "UpdateUnitData",
