 function AddInfo() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "QZinfoHandler.ashx?val1=" + ctn_no + "&val2=" + QZDate +
            ...
            "&val9=" + QZCheckpti + "&val10=" + QZTranFee + "&val11=" + total+"&val88="+"AddQzInfo",
                ...
                success: function (ret) {
                    ...
                    var str = JSON.stringify(ret.response);
        ...
        function QueryQZinfo() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "QZinfoHandler.ashx?val1=" + ctn_no + "&val88=" + "QueryQZInfo",

                success: function (ret) {

                    var str = JSON.stringify(ret.dtQzinfo);
